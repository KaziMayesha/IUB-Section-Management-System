        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#pablo"> Available Resources </a>
                            ...
                            <div class="card strpied-tabled-with-hover">
                                ...
                                <div class="card-body table-full-width table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                          <?php
                                          $classroom_info = "SELECT * FROM classroom;";
                                          ...
                                          if($countArray->num_rows>0)
                                          {
                                            while($row=$countArray->fetch_assoc())
                                            {
                                              ...
                                              echo   "<td> ". ($row['resource']*$row['size'])."</td>";
                                              $sum_capacity=$sum_capacity+($row['resource']*$row['size']);
                                    ...
                                    <table class="table table-hover table-striped">
                                        <tbody>
                                          <tr>
                                            ...
                                            $classroom_info = "SELECT SUM(resource) AS Resource FROM classroom;";

                                            $countArray= $dbconnect->query($classroom_info);
                                            $total_resource=$countArray->fetch_array();
                                          ...
                                          <tr>
                                            ...
                                            <th> <?php echo $sum_capacity; ?> </th>
                                            <th>    </th>
                                          </tr>

                                          <tr>
                                            <th> Total Capacity with 7 slot 2 days: </th>
                                            <th> <?php echo ($sum_capacity)*(7*2); ?> </th>
                                            <th>    </th>
                                          </tr>
                                          <tr>
                                            <th> Total Capacity with 8 slot 2 days: </th>
                                            <th> <?php echo ($sum_capacity)*(8*2); ?> </th>
                                            <th>    </th>
                                          </tr>
